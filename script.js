...
function playGame(box){
    if (turn%2==0){
        box.innerHTML=`<h1 class="playa">${player}</h1>`
        player="O"
    } else{
        box.innerHTML=`<h1 class="playa">${player}</h1>`
        player="X"
...
let final=document.getElementsByClassName('final-screen')
function checkTheWinner(){
    ...
    let str2=box1.textContent+box2.textContent+box3.textContent;
    ...
    let str6=box4.textContent+box5.textContent+box6.textContent;
    let str7=box7.textContent+box8.textContent+box9.textContent;
    let str8=box3.textContent+box5.textContent+box7.textContent;
